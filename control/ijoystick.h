...
public:
    ...
    enum Position
	{
        Center 	= 0x00 ,	///< @brief The joystick is centered (idle).
        Left 	= 0x01 ,	///< @brief The joystick has been moved to or is at the left.
        Right	= 0x02 ,	///< @brief The joystick has been moved to or is at the right.
        Up		= 0x04 ,	///< @brief The joystick has been moved upwards or is in the up position.
        Down	= 0x08 ,	///< @brief The joystick has been moved downwards or is in down position.
        Pressed = 0x10		///< @brief The joystick has been pressed at the center.
	};
